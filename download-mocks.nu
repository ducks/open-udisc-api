...
http get 'https://udisc.com/courses/evergreen-state-college-B2ox/leaderboard.data?layoutId=34929&dateRange=30 Days&_routes=routes/courses/$slug/leaderboard' | save -f 'tests/mocks/courses/evergreen-leaderboard.json'
